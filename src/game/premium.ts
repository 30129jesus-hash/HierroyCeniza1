...
export const FRAMES: FrameDef[] = [
  { id: 'frame_sangre', name: 'Sello de Sangre', desc: 'Un acento carmesí que late con la furia del combate. La rareza sigue mandando el borde.', price: 300, icon: 'heart', accent: '#e02f45', glow: 'rgba(224,47,69,0.5)', anim: 'none' },
  { id: 'frame_oro', name: 'Oro de Medianoche', desc: 'Oro viejo sobre negro absoluto. Para quien ya lo ganó todo y quiere que se note.', price: 300, icon: 'coin', accent: '#ffd76a', glow: 'rgba(255,215,106,0.45)', anim: 'none' },
  { id: 'frame_hielo', name: 'Escarcha Eterna', desc: 'Un filo de hielo que nunca se derrite. Sereno, letal, hermoso.', price: 300, icon: 'ice', accent: '#6fe8ff', glow: 'rgba(111,232,255,0.5)', anim: 'frost' },
  { id: 'frame_abismo', name: 'Demonio del Abismo', desc: 'Llamas vivas lamen el borde de cada carta. Solo existe mientras dure la temporada.', price: 450, icon: 'demon', accent: '#ff8c3b', glow: 'rgba(255,140,59,0.75)', anim: 'flames', limited: true },
  { id: 'frame_ceniza', name: 'Ceniza Inmortal', desc: 'Brasas que nunca se apagan, como el rencor de un reino caído. Marco de temporada.', price: 450, icon: 'fire', accent: '#c22536', glow: 'rgba(194,37,54,0.7)', anim: 'embers', limited: true },
];
